...
function getMockNews() {
  const n = new Date();
  return [
    { title:'Massive Storm System Expected to Impact Eastern Seaboard This Weekend', url:'#',
    ...
    { title:'Record High Temperatures Sweep Through Southern Europe', url:'#',
    ...
    { title:'Arctic Blast to Bring Bone-Chilling Cold to Northern States', url:'#',
    ...
    { title:'Hurricane Season Forecast: Above-Normal Activity Expected', url:'#',
    ...
    { title:'Flash Flood Emergency Declared in Western Texas', url:'#',
    ...
    { title:'Wildfire Risk Elevated Across California Due to Dry Conditions', url:'#',
    ...
    { title:'Spring Tornado Outbreak: Multiple Twisters Touch Down in Tornado Alley', url:'#',
      urlToImage:'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400',
      publishedAt:new Date(n-72000000).toISOString(), source:{name:'Storm Tracker'}, category:'Tornado' },
    { title:'AI-Powered Model Achieves 14-Day Forecast Accuracy Milestone', url:'#',
    ...
    { title:'Climate Change Intensifying Global Weather Patterns, Scientists Warn', url:'#',
